    ...
    <div className="app-shell" data-planet={activeTheme.planet.variant} data-section={activeSection} ref={appShell} style={progressStyle}>
      ...
      <main id="main-content">
          ...
          <div className="hero-grid">
            <div className="hero-copy reveal">
              ...
              <div className="hero-actions">
                ...
                <a className="text-link" href="/api/resume" download={contact.resumeName}><Download size={17} aria-hidden="true" /> Download résumé</a>
              </div>
            </div>
        ...
        <section className="contact-section chapter" id="contact" aria-labelledby="contact-title">
          <div className="contact-card reveal"><p className="eyebrow">04 · Get in touch</p><h2 id="contact-title">Want to work together?</h2><p>{contact.intro}</p><div className="contact-actions"><a className="primary-button" href={`mailto:${contact.email}`}><Mail size={18} aria-hidden="true" /> Email me</a><a className="contact-link" href={contact.linkedin} target="_blank" rel="noreferrer"><ContactRound size={18} aria-hidden="true" /> LinkedIn <ExternalLink size={14} aria-hidden="true" /></a><a className="contact-link" href={contact.github ?? defaultPortfolio.contact.github} target="_blank" rel="noreferrer"><GitHubMark /> GitHub <ExternalLink size={14} aria-hidden="true" /></a></div><a className="email-display" href={`mailto:${contact.email}`}>Start a conversation</a></div>
        </section>
      </main>
